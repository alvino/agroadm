  ...
  return (
    <div>
      <div
        ...
        style={{
          backgroundImage: "url(" + require("assets/img/pagechange3.jpg") + ")",
      ...
      <div className="my-32 mx-auto max-w-sm text-center relative z-50 top-0">
        <div className="block mb-4">
          <i className="fas fa-circle-notch animate-spin text-white mx-auto text-6xl w-4"></i>
        </div>
        <h4 className="text-lg font-medium text-white">
          {props.path === "/" ? "Pagina principal" : props.path}
        </h4>
      </div>
    </div>
  );
